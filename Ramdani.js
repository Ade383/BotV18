...
fake = setting.fake
ownerName = 'Ramdani Official'
ownerNumber = '6289512545999'
aktor = 'Ramdani Official' //JAN DI UBAH NANTI ERROR!!
Ramdani = '```'
...
if (anu.action == 'add' && !mem.includes(Ramdani.user.jid)) {
			 ...
			 const bosco2 = bosco1.message["ephemeralMessage"] ? bosco1.message.ephemeralMessage : bosco1
                ...
                teks = `*Haii* @${num.split('@')[0]} 👋\n💌 *Bɪᴏ* : *${thu.status}*\n🌼 *Mᴇᴍʙᴇʀs : ${memeg}*\n🌺 *Wᴇʟᴄᴏᴍᴇ Tᴏ* \n *${mdata.subject}*\n*Subscribe My Channel*\n*https:https://youtube.com/channel/UCB157jomCne961WzYHpG4gg*\n✨ *Dᴏɴᴛ Fᴏʀɢᴇᴛ Dɪsᴄʀɪᴘᴛɪᴏɴ* \n *${mdata.desc}*\n ${time_wel} -  ${time_welc}`
 ...
 let command = chats.split(/ +/g)[0];
    ...
    const q = args.join(" ");
			...
			mess = {
				...
				success: 'Nih kak jangan luh subs https:https://youtube.com/channel/UCB157jomCne961WzYHpG4gg',
				error: {
		  ...
		  if (budy.includes("https://chat.whatsapp.com/")) {
           ...
           Ramdani.sendMessage(from, teks, text, {
                   quoted: {
                           ...
                           },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(".src/fake.jpg"),"itemCount":9999999999,"status":"INQUIRY","surface":"CATALOG","message": `© Creator By Ramdani Official`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}},
...
let settingstatus = 0;
    if (new Date() * 1 - settingstatus > 1000) {
      ...
      await Ramdani.setStatus(`Aktif selama ${uptime} | spam/vc/telfon?block | Sewa Bot Only |Subscribe Ramdani Official🗿`).catch((_) => _);
...
footerText: `_*© Creator by Ramdani Official*_`,
buttons: tete,
headerType: 4
}
...
_Selamat datang di sewa bot BY Ramdani Official_`
...
╰━━━━━━━━━━━━━━━━━`
            ...
            contentText: `_© Creator by Ramdani Official_`,
    ...
    case 'anal':
          ...
          pll = `© Creator by Ramdani Official`
...
tod = await getBuffer(`https://telegra.ph/file/42bbb3c9962702d314008.jpg`)
                 Ramdani.sendMessage(from, tod, image, { quoted: mek, caption: '*JANGAN LUPA SUBS CHANNEL PENGEMBANG BOT https:https://youtube.com/channel/UCB157jomCne961WzYHpG4gg*'})
                 break
   case 'ytb':
                if (args.length < 1) return reply('*https://youtube.com/channel/UCB157jomCne961WzYHpG4gg*')
                break
  case 'insta':
   ...
   case 'bokep':
                ...
                break
case 'jadibot':
                if (args.length < 1) return reply('*jika ingin menjadi bot silahkan tonton channel YouTube Ramdani Official*/nhttps://youtube.com/channel/UCB157jomCne961WzYHpG4gg')
                break
				case 'unban':
					if (!isOwner) return reply(mess.only.ownerB)
					bnnd = body.slice(8)
...
case 'stiker': 
				...
				case 'meme':
					...
					Ramdani.sendMessage(from, buffer, image, {quoted: mek, caption: 'Tuh meme by Ramdani Official'})
					break
				/*case 'memeindo':
